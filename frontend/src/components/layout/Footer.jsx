                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div className="col-span-1 md:col-span-2">
                        <div className="flex items-center mb-4">
                            ...
                            <span className="text-xl font-bold">Community Mangrove Watch</span>
                        </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li>
                                <Link to="/reports/submit" className="text-gray-300 hover:text-white transition-colors">
                                    Submit Report
                                </Link>
                            </li>
                            <li>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8">
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <div className="flex items-center text-gray-400 text-sm mb-4 md:mb-0">
                            ...
                            <span>Protecting mangrove ecosystems worldwide</span>
                        </div>
                    ...
                    <div className="mt-4 text-center text-gray-400 text-sm">
                        <p>&copy; {currentYear} Community Mangrove Watch. All rights reserved.</p>
                        <p className="mt-1">
                            This project is supported by environmental organizations and dedicated volunteers.
                        </p>
                    </div>
                </div>
            </div>
